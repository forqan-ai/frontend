...
export const ADMIN_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            '../live-sessions/Pages/admin-bookings/admin-bookings.component'
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './pages/admin-withdrawals/admin-withdrawals.component'
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './pages/admin-withdrawal-details/admin-withdrawal-details.component'
          ).then((m) => m.AdminWithdrawalDetailsComponent),
